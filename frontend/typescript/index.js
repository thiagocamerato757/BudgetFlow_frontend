...
var msgBoasVindas = document.getElementById("mensagem");
function hideLoginAndSignupLinks() {
    var loginLink = document.querySelector('nav a[href="login.html"]');
    var signupLink = document.querySelector('nav a[href="cadastro.html"]');
    if (loginLink) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, fetch(constantes_1.IS_LOGGED_IN_URL, {
                            method: "GET",
                            headers: {
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error("Erro ao verificar autenticação:", error_1);
                    removeLogoutButton();
                    genericmessage();
                    return [3 /*break*/, 7];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, fetch(constantes_1.LOGOUT_URL, {
                            method: "DELETE",
                            headers: {
                                Authorization: "token ".concat(token)
                            }
                ...
                case 4:
                    errorData = _a.sent();
                    alert("Erro ao deslogar: ".concat(errorData.error || "Desconhecido"));
                    _a.label = 5;
                case 5: return [3 /*break*/, 7];
                case 6:
                    error_2 = _a.sent();
                    alert("Erro de rede: ".concat(error_2));
                    return [3 /*break*/, 7];
                case 7: return [2 /*return*/];
            }
        });
...
function updatename(name) {
    msgBoasVindas.textContent = "Bem-vindo ao Budget Flow ".concat(name, "!");
}
