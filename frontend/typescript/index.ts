...
function hideLoginAndSignupLinks(): void {
    ...
    if (signupLink) {
        (signupLink as HTMLElement).style.display = "none";
    }
}

function showLoginAndSignupLinks(): void {
    const loginLink = document.querySelector('nav a[href="login.html"]');
    const signupLink = document.querySelector('nav a[href="cadastro.html"]');

    if (loginLink) {
        (loginLink as HTMLElement).style.display = "inline"; // Torna visível novamente
    }
    if (signupLink) {
        (signupLink as HTMLElement).style.display = "inline"; // Torna visível novamente
    }
}
...
function updateNavbarForAuthenticatedUser(): void {
...
function removeLogoutButton(): void {
